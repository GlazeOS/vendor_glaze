...
# Copyright (C) 2017 The GlazeOS Project
#
...
custom_local_manifest = ".repo/local_manifests/_manifest.xml"
custom_default_revision = "ng7.0"
custom_dependencies = ".dependencies"
org_manifest = "GlazeOS"  # leave empty if org is provided in manifest
org_display = "GlazeOS"  # needed for displaying
